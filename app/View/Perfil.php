...
<body class="bg-light">	
	<div class="container">
		<div class="py-4">
        <a href="http://localhost/guararapesnatacao/aluno">
            <img class="rounded-circle" src="http://localhost/guararapesnatacao/upload/alunos/<?php echo $_SESSION['id'] ?>.jpg" alt="image" width="100" height="100"><br><br>
		</a>         
        <h2>Meu perfil</h2>
		</div>		
			<?php $u = new Aluno();
			$dados = $u->selecionaAluno($_SESSION['id']);?>

            <form action="http://localhost/guararapesnatacao/aluno/salvarAlteracoes" method="POST">	 
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <input type="text" name="observacoes" id="observacoes" value="<?php echo $dados['observacao'];?>" class="form-control" id="observacoes" maxlength="200" required>
							...
							<div class="col-md-9 mb-2">
									<button class="btn btn-outline btn-primary" value="<?php echo $dados["id"]?>" name="idaltera">Salvar alterações</button>
							</div>   
							<div class="col-md-3 mb-2">
							<a href="http://localhost/guararapesnatacao/aluno/excluir" onclick="return confirm('Seu perfil será excluido. Deseja continuar?')" name="id">Excluir meu perfil</a>
							</div>	
							</div>	
