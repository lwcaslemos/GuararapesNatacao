...
<html lang="pt-br">
  ...
  <body class="bg-light">
    <div class="container">
      ...
      <?php   
        ...
        ?>
        <a href="http://localhost/guararapesnatacao/">
        <?php } ?>
  ...
  <?php
      if($aux == "admin"){ ?>
    	  <form action="http://localhost/guararapesnatacao/admin/cadastraraluno" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
      <?php }
      else {
      ?>  
        <form action="http://localhost/guararapesnatacao/login/cadastraraluno" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
      <?php } ?>   
