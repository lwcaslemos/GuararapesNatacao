...
<body class="bg-light">	
	<div class="container">
        ...
        <h2>Meu perfil</h2>
			...
			$dados = $f->selecionaFuncionario($_SESSION['id']);?>

            <form action="http://localhost/guararapesnatacao/admin/salvarAlteracoes" method="POST">	 
            ...
            <div class="row">
                <div class="col-md-12 mb-3">
                    ...
                    <input type="text" name="observacoes" id="observacoes" value="<?php echo $dados['observacao'];?>" class="form-control" id="observacoes" maxlength="200" required>
							...
							<a href="http://localhost/guararapesnatacao/admin/excluir" onclick="return confirm('Seu perfil será excluido. Deseja continuar?')" name="id">Excluir meu perfil</a>
							</div>	
							</div>	
