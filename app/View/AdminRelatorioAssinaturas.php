...
<?php 
    ...
    if(isset($_POST['periodo'])){
      if($_POST['periodo'] == "Dia"){
        $dadosplano = $relatorio->contratacoesDia();
      }
      else if($_POST['periodo'] == "Ano"){
        $dadosplano = $relatorio->contratacoesAno();
      }
      else if($_POST['periodo'] == "Mes"){
        $dadosplano = $relatorio->contratacoesMes();
      }
    }
    else{
      $dadosplano = $relatorio->contratacoesDia();
...
<div class="pricing-header p-3 pb-md-4 mx-auto text-center">
    ...
    <p class="fs-4 text-muted">Quantidade de assinaturas por período e por plano</p>
</div>
    ...
    <div class="row">		
     ...
     <table class="table table-bordered border-primary table-sm">
      ...
      foreach ($dadosplano as $dado){ ?>
        <tr>
          <td ><?php echo $dado["data_compra"];?></td>  
