...
<?php 
    ...
    if(isset($_POST['periodo'])){
      if($_POST['periodo'] == "Dia"){
        $dadosplano = $relatorio->pagamentosRecebidosDia();
      }
      else if($_POST['periodo'] == "Ano"){
        $dadosplano = $relatorio->pagamentosRecebidosAno();
      }
      else if($_POST['periodo'] == "Mes"){
        $dadosplano = $relatorio->pagamentosRecebidosMes();
      }
    }
    else{
      $dadosplano = $relatorio->pagamentosRecebidosDia();
...
<div class="pricing-header p-3 pb-md-4 mx-auto text-center">
    ...
    <p class="fs-4 text-muted">Quantidade de pagamentos recebidos por período e por forma de pagamento</p>
</div>

<form action="http://localhost/guararapesnatacao/admin/quantidadepagamentos" class="w-100 me-3" method="post">
    <div class="row">		
